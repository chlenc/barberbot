...
const TOKEN = '533338965:AAE69lTP7uAa2NiiXQeFKpQ6FM8XAj79EVM';
...
firebase.initializeApp({
    ...
    databaseURL: "https://barberbot-3b164.firebaseio.com"
})
...
bot.on('message', msg => {
    ...
    if(msg.contact){
        ...
        bot.sendMessage(chatId, '📃 Прайс лист:\n'+
            'Мужская стрижка 1700 ₽\n' +
            'Стрижка машинкой 800 ₽\n' +
            'Детская стрижка 1500 ₽\n' +
            'Моделирование бороды 1200 ₽\n' +
            'Стрижка бороды 800 ₽\n' +
            'Бритьё опасной бритвой 1500 ₽\n' +
            'Королевское бритьё 2500 ₽\n' +
            'Коррекция воском 500 ₽\n' +
...
bot.onText(/\/help/, msg => {
    bot.sendMessage(msg.chat.id, 'Я смогу помочь вам записаться приём. Так-же могу познакомить вас с прайс листом.', homeKey)
})
